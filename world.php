                ...
                <div class="flex-box contenido">
                    <article class="fondo">
                        <div class="borde-juego">
                            <h2>Mundo</h2>
                            <div class="flex-box world-page">
                                <ol class="menu-world">
                                    <li><a href="#">Himalia</a></li>
                                    <li><a href="#">Civilizaci&oacute;n</a></li>
                                    <li><a href="#">Organizaciones</a>
                                        <ul>
                                            <li><a href="#">La Gran Alianza</a></li>
                                            <li><a href="#">El Culto de Azmodeo</a></li>
                                            <li><a href="#">El Imperio de Helldur</a></li>
                                            <li><a href="#">Las Golems</a></li>
                                        </ul>
                                    </li>
                                </ol>
