                            ...
                            <div class="tabs flex-box charaters-page">
                                <nav id="scrolling-2" class="menu-characters texto-contenido">
                                    <ul>
                                        ...
                                        <li><a href="#character-14"><img src="img/char1.gif"></a></li>
                                        <li><a href="#character-15"><img src="img/char1.gif"></a></li>
                                        <li><a href="#character-16"><img src="img/char1.gif"></a></li>
                                        <li><a href="#character-17"><img src="img/char1.gif"></a></li>
                                        <li><a href="#character-18"><img src="img/char1.gif"></a></li>
                                    </ul>
                                </nav>
